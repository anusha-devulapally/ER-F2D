...
class SequenceMVSEC(Dataset):
    ...
    def __init__(self, base_folder, event_folder="events", depth_folder='frames', frame_folder='rgb', flow_folder='flow',
        ...
        if baseline == "rgb":
            ...
            self.dataset = MVSEC_Data(base_folder, clip_distance=clip_distance, transform=transform,normalize=normalize, nbr_of_events_per_voxelgrid=nbr_of_events_per_voxelgrid,nbr_of_bins=nbr_of_bins)
...
class MVSEC_Data(Dataset):
    def __init__(self, base_folder,
        ...
        if "ddd17" in base_folder:
            ...
            print("self.dataset_Raw", self.dataset_raw)
            self.length = len(self.dataset_raw)
